  ...
  return (
    ...
    >
      <motion.form
        ...
        className="max-w-[560px] w-full bg-white dark:bg-[#0b2b26] border border-neutral-200 dark:border-neutral-700 rounded-xl overflow-hidden shadow-xl dark:shadow-none"
      >
        {/* Header */}
